...
<?php  }else{  ?>
    <ul class="vertical-menu__list">
        <li class="vertical-menu__item">
            <a href="/product?item=sushi" class="vertical-menu__link">Суши</a>
        </li>
        <li class="vertical-menu__item">
            <a href="/product?item=rolls" class="vertical-menu__link ">Роллы</a>
        </li>
        <li class="vertical-menu__item">
            <a href="/product?item=baked_rolls" class="vertical-menu__link ">Запечённые роллы</a>
        </li>
        <li class="vertical-menu__item">
            <a href="/product?item=set" class="vertical-menu__link ">Наборы</a>
        </li>
        <li class="vertical-menu__item">
            <a href="/product?item=pizza" class="vertical-menu__link">Пицца</a>
        </li>
        <li class="vertical-menu__item">
            <a href="/product?item=wok" class="vertical-menu__link <?php if ($_GET['item']=='wok') echo 'vertical-menu__link--active"' ?>">Лапша WOK</a>
        </li>
